...
$router->add('/admin/deleted-books', 'AdminController', 'deletedBooks');
$router->add('/admin/restore-book', 'AdminController', 'restoreBook');
$router->add('/admin/permanently-delete-book', 'AdminController', 'permanentlyDeleteBook');
$router->add('/admin/categories', 'AdminController', 'categories');
$router->add('/admin/add-category', 'AdminController', 'addCategory');
...
$router->add('/teacher/upload-resource', 'TeacherController', 'uploadResource');
$router->add('/teacher/delete-resource', 'TeacherController', 'deleteResource');
$router->add('/teacher/track-view', 'TeacherController', 'trackView');
