                ...
                <div class="card-body p-3">
                    <form method="POST" action="<?= BASE_PATH ?>/admin/edit-library">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control form-control-sm" id="address" name="address" rows="2" required><?= htmlspecialchars($library['address']) ?></textarea>
                        </div>
                        ...
                        <div class="d-flex gap-2 justify-content-end mt-3">
                            ...
                            <button type="submit" class="btn btn-primary btn-sm">Update Library</button>
                        </div>
                    </form>
                </div>
            </div>
